...
type StreamConfigs struct {
	UserLifecycle StreamConfig `mapstructure:"user_lifecycle"`
}
...
func LoadConfig() (*Config, error) {
	...
	v.AddConfigPath(".")
	v.AddConfigPath("/etc/kafka-consumer-worker/")
	v.AddConfigPath("$HOME/.kafka-consumer-worker")
...
func setDefaults(v *viper.Viper) {
	...
	v.SetDefault("database.database", "kafka-consumer-worker")
